  ...
  toSDL(opts) {
    const _ref = opts || {},
      ...
      deep
          ...
          restOpts = _objectWithoutProperties(_ref, ["deep"]);

    if (deep) {
      let r = '';
      r += (0, _schemaPrinter.printInputObject)(this.getType(), restOpts);
    ...
    return (0, _schemaPrinter.printInputObject)(this.getType(), restOpts);
  }
